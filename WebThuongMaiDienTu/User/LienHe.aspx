<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="LienHe.aspx.cs" Inherits="WebThuongMaiDienTu.User.LienHe" %>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <div class="control-group">
                            <input type="text" class="form-control" id="Tên" placeholder="Họ"
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Vấn đề của bạn"
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p>Tôi cần đổi size áo</p>
                <div class="d-flex flex-column mb-3">
                    <h5 class="font-weight-semi-bold mb-3">Store 1</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Hàn Thuyên, Hải Châu 2, Đà Nẵng</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+84 345 67890</p>
                </div>
                <div class="d-flex flex-column">
                    <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Trần Cao Vân, Liên Chiễu, Đà Nẵng</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
