<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="ThanhToan.aspx.cs" Inherits="WebThuongMaiDienTu.User.ThanhToan" %>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Tên</label>
                            <input class="form-control" type="text" placeholder="Van A">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Họ</label>
                            <input class="form-control" type="text" placeholder="Nguyen">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="84 94843823">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Địa chỉ thứ 1</label>
                            <input class="form-control" type="text" placeholder="123 Nguyễn Văn Linh">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Địa chỉ thứ 2</label>
                            <input class="form-control" type="text" placeholder="123 Lê Duẩn ">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Quận</label>
                            <input class="form-control" type="text" placeholder="Cẩm Lệ">
                        </div>
                        <div class="col-md-6 form-group">
                ...
                <div class="collapse mb-4" id="địa chỉ giao hàng">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Số điện thoại</label>
                            <input class="form-control" type="text" placeholder="+84 456 789">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Địa chỉ thứ 1</label>
                            <input class="form-control" type="text" placeholder="123 Nguyễn Văn Linh">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p>Áo đấu sân nhà Nike Chelsea 2024-25</p>
                            <p>$150</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Áo đấu sân khách của Chelsea Nike 2024-25</p>
                            <p>$150</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Áo đấu thứ ba của Chelsea Nike Stadium 2024-25</p>
                            <p>$150</p>
                        </div>
                        <hr class="mt-0">
